...
;; http://java.ociweb.com/mark/clojure/article.html#DesktopApps

;; Swing based GUI
;; proxy macro - create Java object that extends Java class and implements interfaces
...
(defn message
  "gets the message to display based on the current text in the text field"
  [text-field]
  (str "Hello, " (.getText text-field) "!"))

; Set the initial text on name-field to "World"
...
(let [name-field (JTextField. "World" 10)
  ...
  ; Register frame to liste for greet-button presses.
